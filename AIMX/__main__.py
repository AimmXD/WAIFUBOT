...
from AIMX import application, AIM, LOGGER 
from AIMX.modules import ALL_MODULES
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("AIMX.modules." + module_name)
